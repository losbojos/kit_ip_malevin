...
Веб-приложение для учёта выполненных работ на строительном объекте: добавление и редактирование записей, просмотр списка, фильтрация по дате, удаление.
...
Если сайт долго открывается, не загружаются данные или ввидите ошибки сети (`Failed to fetch`, `ERR_CONNECTION_CLOSED`) — попробуйте **включить VPN** и обновить страницу. Доступ к Vercel или Supabase может быть нестабильным без VPN.
